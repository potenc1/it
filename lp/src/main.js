(function($){
    ...
    var Lang = {
        ...
        gr: {
            ...
            maxPurchase: 'Ο μεγαλύτερος αριθμός παραγγελιών (_COUNT_) δόθηκε σε _DATE_ _MONTH_ 2016.',
    ...
    Landing.prototype.initCountDown = function() {
        ...
        var countDownTimer = setInterval( function () {
            ...
            m = new String(m);
            s = new String(s);
            var htmlTime = '<div class=timebox>' + '<span class="hours">'+ h[0] +'</span>'+ '<span class="hours">'+ h[1] +'</span>'+ "</div>" +
                           '<div class=timebox>' + '<span class="minutes">'+ m[0] +'</span>'+ '<span class="minutes">'+ m[1] +'</span>'+ "</div>" +
                           '<div class=timebox>' + '<span class="seconds">'+ s[0] +'</span>' +'<span class="seconds">'+ s[1] +'</span>'+ "</div>";
